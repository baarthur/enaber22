...
author: "Arthur Bazolli Alvarenga, Ari Francisco de Araujo Junior, Admir Antonio Betarelli Junior"
institute: "Salvador"
date: "2022/09/28"
bibliography: yaml/Monografia.json
csl: yaml/ipea.csl
output:
  xaringan::moon_reader:
    ...
    nature:
      ...
      ratio: "16:9"
    pandoc_args: 
      - '--lua-filter=C:/Users/arthu/OneDrive/Documentos/R/Projects/pres_enaber22/slides/yaml/scholarly-metadata.lua'
      - '--lua-filter=C:/Users/arthu/OneDrive/Documentos/R/Projects/pres_enaber22/slides/yaml/author-info-blocks.lua'
    includes:
...
.pull-right[
```{r redevelop, out.width="75%", dev.args = list(bg = "transparent"), include=TRUE}
knitr::include_graphics("https://caosplanejado.com/wp-content/uploads/2022/06/imagem1.png")
```
]
...
```{r imoveis, include=TRUE, cache=FALSE}
...
.center[
```{r crime, include=TRUE, cache=FALSE}
...
.center[
```{r parques, include=TRUE, cache=FALSE}
...
.center[
```{r aop, include=TRUE, cache=TRUE, fig.height=5, dev.args = list(bg = "transparent")}
...
* Não significativo em todos os modelos prêmio de mercado **não** identificado
...
* Possíveis causas
  ...
  + Sobreposição de redes (Metrô, CPTM, corredores de ônibus)
  
```{r rede, out.width: "25%", include = TRUE}
mapa_rede
```
]
...
* Arthur Bazolli Alvarenga
  + [arthur.bazolli@estudante.ufjf.br](arthur.bazolli@estudante.ufjf.br)
  + [github.com/baarthur0/](github.com/baarthur0/)
* Ari Francisco de Araujo Junior
  + [ari.junior@professores.ibmec.edu.br](ari.junior@professores.ibmec.edu.br)
* Admir Antonio Betarelli Junior
  + [admir.betarelli@ufjf.br](admir.betarelli@ufjf.br)
